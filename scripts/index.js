...
function getCardElement(cardData) {
  ...
  const modalImage = previewModal.querySelector(
    ".modal__preview_modal__preview_image"
  );
  const previewCaption = previewModal.querySelector(
    ".modal__preview_modal__preview_caption"
  );
